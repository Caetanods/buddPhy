...
#' @param sim the output from ‘sim_Mk_budding_exp’, ‘sim_Mk_trace_history’, ‘sim_BM_budding_exp’, or ‘sim_BM_trace_history’
#' @param target_mean_rate a numeric value. The target average rate of trait evolution. For discrete traits, this is the equal rates model (ER).
#'
