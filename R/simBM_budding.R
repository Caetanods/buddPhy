#' Simulate continuous traits under a lineage-age dependent model
#'
...
sim_BM_budding_exp <- function(tree, sigma, anc = 0.0, budding_prob = 0.0, budding_mother = NA, change_rate = 2.0, decay_fn = TRUE){
    ...
    return( list(phy_sim = tt, tip_state = x, edge_state = STATES
